...
import { Plus, MoreHorizontal, Flag, GripVertical, User } from 'lucide-react';
...
const BoardView = () => {
  ...
  const handleDragOver = (e: React.DragEvent, statusId: string) => {
    e.preventDefault();
    dragOverColumn.current = statusId;
        ...
        return (
          <div
            ...
            className={`flex flex-col min-w-[280px] max-w-[320px] w-[300px] flex-shrink-0 rounded-xl transition-all duration-200 ${
              isOver ? 'bg-white/5 ring-2 ring-purple-500/40' : 'bg-[#1a1a1a]/50'
            }`}
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-2">
              ...
              {addingToColumn === status.id && (
                <div className="bg-[#1e1e1e] border border-purple-500/40 rounded-lg p-3">
                  <input
                    type="text"
                    autoFocus
                    value={newTaskName}
